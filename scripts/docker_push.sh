...
docker build -t eu.gcr.io/census-int-ci/census-field-service-cucumber:$VERSIONTAG .
docker push eu.gcr.io/census-int-ci/census-field-service-cucumber:$VERSIONTAG
